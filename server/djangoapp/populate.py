...
def initiate():
    car_make_data = [
        {"name":"NISSAN", "description":"Great cars. Japanese technology", "price": "2000"},
        {"name":"Mercedes", "description":"Great cars. German technology", "price": "1000"},
        {"name":"Audi", "description":"Great cars. German technology", "price": "2500"},
        {"name":"Kia", "description":"Great cars. Korean technology", "price": "2060"},
        {"name":"Toyota", "description":"Great cars. Japanese technology", "price": "4000"},
    ]

    car_make_instances = []
    for data in car_make_data:
            car_make_instances.append(CarMake.objects.create(name=data['name'], description=data['description'], price=data['price']))
